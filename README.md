...
## Training
Nonetheless I probably still had the most productive training block of my life this summer (outside of hiking the PCT), made possible by good training partners, outdoor access, and an abundance of stoke. Most my summer weekends included a 25+ mile long run in the mountains which barely felt like training and more like plain old fun. I also got really into CityStrides and trying to run every street in Seattle earlier this summer, which kept city running fresh when I didn't have access to the mountains

I didn't have any significant hitch hiking missions this summer but instead got really into mixing public transit, bikepacking, and trail running for weekend outings. I would take public transit as far as I could within reason, start biking to the trailhead, camp at trailhead, go for long run the next day, and than bike back. It felt like a fun and creative way to spend a weekend with a mixture of all my favorite activities: trail running, camping, and cycling. The virtues of car free living is that it will get you dummy fit if you need to get to the mountains. 
...
I usually only did a single intensity session per week which more often than not ended up being track intervals with Club Northwest on Tuesday. I sometimes added a tempo later on the week once deeper into the build which was something like 3-6 miles at MP or hills workout. 
